...
public class DemoHandleAlert  extends BaseTest {
    @Test
    public void demoHandleAlertAccept() {
        ...
        Assert.assertEquals(message, "I am an alert box!", "Message hiển thị không đúng.");
        sleep(1);
        alert1.accept();
...
//        alert2.dismiss();
        ...
        Assert.assertEquals(driver.findElement(By.xpath("//p[@id='confirm-demo']")).getText(), "You pressed Cancel!", "Incorrect Message");
        sleep(1);
    }
    @Test
    public void demoHandleAlertInputText() {
        ...
        actions.moveToElement(driver.findElement(By.xpath("//h4[normalize-space()='Tutorials Menu']"))).perform();
        sleep(2);
